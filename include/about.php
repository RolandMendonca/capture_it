...
<body>
                                            ...
                                            <ul id="navigation">
                                                ...
                                                <li><a href="#">Categories <i class="ti-angle-down"></i></a>
                                                    <ul class="submenu">
                                                        ...
                                                        <li><a href="Videography.html">Videogarphy</a></li>
                                                ...
                                                <li><a href="#">Gallery <i class="ti-angle-down"></i></a>
                                                    <ul class="submenu">
                                                        ...
                                                        <li><a href="single-blog.html">Arial</a></li>
                                                    </ul>
                                                </li>
            ...
            <div class="row align-items-center">
                <div class="col-xl-6 col-md-6">
                    <div class="about_thumb">
                        <img src="img/about/about_big.png" alt="">
                        <div class="small_img_1">
                            <img src="img/about/small_2.png" alt="">
                        </div>
                        <div class="small_img_2">
                            <img src="img/about/small_1.png" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-xl-6 col-md-6">
    ...
    <div class="section-top-border">
        <h3 class="mb-30">Our site visits/Year</h3>
        <div class="progress-table-wrap">
            <div class="progress-table">
                ...
                <div class="table-row">
                    ...
                    <div class="country"> <img src="img/elements/f2.jpg" alt="flag">USA</div>
                    <div class="visit">645032</div>
                    <div class="percentage">
                        <div class="progress">
                ...
                <div class="table-row">
                    ...
                    <div class="country"> <img src="img/elements/f3.jpg" alt="flag">UK</div>
                    <div class="visit">645032</div>
                    <div class="percentage">
                        <div class="progress">
                ...
                <div class="table-row">
                    ...
                    <div class="country"> <img src="img/elements/f4.jpg" alt="flag">Chili</div>
                    <div class="visit">645032</div>
                    <div class="percentage">
                        <div class="progress">
                ...
                <div class="table-row">
                    ...
                    <div class="country"> <img src="img/elements/f7.jpg" alt="flag">Bangladesh</div>
                    <div class="visit">645032</div>
                    <div class="percentage">
                        <div class="progress">
                ...
                <div class="table-row">
                    ...
                    <div class="country"> <img src="img/elements/f8.jpg" alt="flag">vietnam</div>
                    <div class="visit">645032</div>
                    <div class="percentage">
                        <div class="progress">
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="text text-center">
                        ...
                        <a href="#" class="boxed-btn2">Add Your Business Here</a>
                    </div>
                </div>
            </div>
        </div>
